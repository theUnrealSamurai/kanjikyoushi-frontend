...
export default function Practice() {
  return (
    <section>
      ...
      <div className="ml-20 bg-purple-700">
        <h1 className="text-4xl font-bold text-white">Kanji</h1>
        <div className="flex gap-6 overflow-x-scroll rounded-2xl mt-5 ml-24 relative bg-slate-600">
          <KanjiCard />
          <KanjiCard />
          <KanjiCard />
          <KanjiCard />
