  ...
  return (
    <section>
      ...
      <div className="ml-20 ">
        ...
        <div className="flex gap-6 overflow-x-scroll rounded-2xl mt-5 ml-24 relative ">
          <KanjiCard />
          <KanjiCard />
          <KanjiCard />
          <KanjiCard />
      ...
      <div className="ml-20 ">
        ...
        <div className="flex gap-6 overflow-x-scroll none-scro rounded-3xl mt-5 ml-24 relative ">
          <WordCard />
          <WordCard />
          <WordCard />
          <WordCard />
